...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*@__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose: __expose }) {
        ...
        const props = __props;
        const jwt = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.jwt ?? '');
        ...
        function validateConfirm() {
            ...
            confirmError.value = _utils_validators__WEBPACK_IMPORTED_MODULE_3__.validators.passwordConfirm(newPassword.value, confirmPassword.value).message;
        }
