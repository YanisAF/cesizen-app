...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*@__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup(__props, { expose: __expose }) {
        ...
        const props = __props;
        const identifier = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.identifier ?? '');
        const channel = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.channel ?? 'email');
